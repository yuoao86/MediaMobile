...
import com.drawshirt.mediamobile.view.VitamioVideoView;
...
public class VitamioVideoPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private void setData() {
        if (mediaItems != null && mediaItems.size() > 0) {
            ...
            isNetUri = UIUtils.isNetUri(uri.toString());
    ...
    private void getData() {
        ...
        //System.out.println("---------------------33333uri===="+uri);
        //System.out.println("---------------------4444uri===="+mediaItems.get(position).getData());
    }
    ...
    private void setVideoType(int type) {
        switch (type) {
            case FULL_SCREEN:
                videoView.onSetVideoSize(screenWidth, screenHeight);
            ...
            case DEFAULT_SCREEN:
                ...
                videoView.onSetVideoSize(width, height);
    ...
    private class MyOnPreparedListener implements MediaPlayer.OnPreparedListener {
        ...
        public void onPrepared(MediaPlayer mediaPlayer) {
            ...
            int totalTime = (int) videoView.getDuration();
